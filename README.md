...
> V06 更新：編輯交易/建倉可換帳戶、所有彈窗支援 ESC 關閉、移除預設帳戶、新使用者引導建立帳戶
...
| 編輯交易/建倉的帳戶 | 個股詳情彈窗內點「編輯」，帳戶下拉選單可更換 |
| 手動更新股價 | 頂部「↻ 更新股價」按鈕 |
...
- 點右上角 ✕ 關閉
- 按鍵盤 **ESC** 關閉
- 多層彈窗時，ESC 優先關閉最上層子彈窗，逐層往回

---

## 帳戶注意事項

- 新使用者進入系統時，帳戶列表為空，會顯示「尚無帳戶，請先建立帳戶」提示
- 未建立帳戶前，無法新增交易紀錄或快速建倉
- 編輯交易紀錄或快速建倉時，可在彈窗內直接更換帳戶
- 換帳戶後，兩邊的持股和 FIFO 均成本會自動重算
- 換帳戶後，建議按一次「↻ 更新股價」以確保現價正確
...
```
情境：把交易紀錄從 A 帳戶移到 B 帳戶

1. 交易紀錄的 account 欄位更新為 B
2. A 帳戶重新用剩餘交易跑 FIFO → 更新 A 的 shares / avg_cost
3. B 帳戶重新用所有交易（含剛移入的）跑 FIFO → 更新 B 的 shares / avg_cost
4. current_price 不受影響，換帳戶後建議手動更新股價
```
...
| V06 | 2026-04-07 | 編輯交易/建倉可換帳戶並重算兩邊FIFO、所有彈窗支援ESC關閉、移除預設帳戶、新使用者引導建立帳戶 |
